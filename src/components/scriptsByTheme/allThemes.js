...
const Amazonas = () => {
    ...
    if (opcionesElegidasParsed.totalSelectionModal) {
        //declarar funcion
    ...
    if (opcionesElegidasParsed.itemProducts) {
        //declarar funcion
        const itemsFunction = `function cambiarLeyendaEnItem(item){
        ...
        //declarar ejecucion de funcion
        const itemsExecution1 = `document.addEventListener('DOMContentLoaded', function () {  
            //Funcion de cambio
            function changeItemPayment(){
                document.querySelectorAll(".js-item-product").forEach(element => {
                    if (!element.querySelector(".custom-cuotas-ts")){
                        let currentItem = element;
                        cambiarLeyendaEnItem(element);
                    }
                });
            }
        ...
        const itemsExecution2 = `$("a.js-load-more").click(function(){
            setTimeout(function() {
    ...
    if (opcionesElegidasParsed.detailMain) {
        //declarar funcion
    ...
    if (opcionesElegidasParsed.cart) {
        //declarar funcion
    ...
    window.onload = ${detailModalExecution1};
...
export { Amazonas, Simple, Idea, Trend, Atlantico, Silent, Lifestyle, Material };